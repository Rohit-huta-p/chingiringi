...
import { Home, Wallet, Users, Bell, Settings, ChevronLeft, ChevronRight, Store, Tag } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.mainNav}>
        ...
        <NavItem
          label="Deals"
          icon={Tag}
          isActive={currentRouteName === 'Deals'}
          onPress={() => navigateTo('Deals')}
          isCollapsed={isSidebarCollapsed}
        />
        <NavItem
          label="Wallet"
